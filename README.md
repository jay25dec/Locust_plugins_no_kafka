#Essentially this is a fork of original locust-plugins.
...
```
pip install locust_plugins_no_kafka
```

Then just `import locust_plugins_no_kafka` in your locustfile and use whatever plugins you need (see below)
